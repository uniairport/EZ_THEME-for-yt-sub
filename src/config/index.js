...
export const config  = {
    ...
    API_CONFIG: {
        ...
        staticBaseUrl: [https://apiapi.ytjcok.com],
    ...
    CUSTOMER_SERVICE_CONFIG: {
        ...
        customHtml: '<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="b28705c2-7308-41fa-82c7-a5ef2afadba5";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>',
